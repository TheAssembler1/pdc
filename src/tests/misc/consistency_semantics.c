...
main(int argc, char **argv)
{
    ...
    TASSERT(PDCprop_set_obj_app_name(obj_prop, "consistency_semantics_test") >= 0,
    ...
    TASSERT(PDCprop_set_obj_consistency_semantics(obj_prop, PDC_CONSISTENCY_POSIX) >= 0,
            "Call to PDCprop_set_obj_consistency_semantics succeeded",
            "Call to PDCprop_set_obj_consistency_semantics failed");
