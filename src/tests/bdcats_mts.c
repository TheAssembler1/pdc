...
main(int argc, char **argv)
{
    ...
    if (!rank) {
        LOG_INFO("Reading %" PRIu64 " number of particles for %d steps with %d clients.\n", numparticles,
                 steps, size);
    }
    ...
    obj_xx   = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_yy   = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_zz   = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_pxx  = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_pyy  = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_pzz  = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_id11 = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    obj_id22 = (pdcid_t *)malloc(sizeof(pdcid_t) * steps);
    ...
    transfer_request_x = (pdcid_t *)malloc(sizeof(pdcid_t) * (steps + 1) * N_OBJS);
    ptr                = transfer_request_x + steps;
