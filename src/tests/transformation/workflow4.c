/**
 * Description: This workflow is identical to workflow 1
 * other than the way it attaches the DG to the PDC resources.
 * It attaches the DG to the object id and from then on the region
 * transfers within this object follow the DG.
 */
