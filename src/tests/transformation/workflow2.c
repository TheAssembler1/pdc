/**
 * Description: This workflow is identical to workflow 1 other
 * than that a type conversion is run as a transformation. When
 * read into client memory the data region should be decompressed
 * doubles. When written to the server the data region should be
 * compressed floats.
 */
