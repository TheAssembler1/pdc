...
{
    switch (z_type) {
        case zfp_type_int32:  LOG_DEBUG("ZFP type: int32\n");  break;
        case zfp_type_int64:  LOG_DEBUG("ZFP type: int64\n");  break;
        case zfp_type_float:  LOG_DEBUG("ZFP type: float\n");  break;
        case zfp_type_double: LOG_DEBUG("ZFP type: double\n"); break;
        case zfp_type_none:
        default:              LOG_ERROR("ZFP type: none/unknown (%d)\n", (int)z_type); break;
    }
}
                                   ...
                                   pdc_tf_region_t input_region, pdc_tf_region_t *output_region)
{
    ...
    switch (input_region.ndim) {
        case 1: field = zfp_field_1d(*region_data, z_type, input_region.size[0]); break;
        case 2: field = zfp_field_2d(*region_data, z_type, input_region.size[0], input_region.size[1]); break;
        case 3: field = zfp_field_3d(*region_data, z_type, input_region.size[0], input_region.size[1], input_region.size[2]); break;
        case 4: field = zfp_field_4d(*region_data, z_type, input_region.size[0], input_region.size[1], input_region.size[2], input_region.size[3]); break;
        case 0: LOG_ERROR("ZFP compression not supported for 0 dimensions\n"); return false;
        default: LOG_ERROR("ZFP compression not supported for > 4 dimensions\n"); return false;
    }
    if (!field) { LOG_ERROR("field was NULL\n"); return false; }
                                     ...
                                     pdc_tf_region_t *output_region)
{
    ...
    switch (in_params->decompressed_region.ndim) {
        case 1: field = zfp_field_1d(buf, z_type, in_params->decompressed_region.size[0]); break;
        case 2: field = zfp_field_2d(buf, z_type, in_params->decompressed_region.size[0], in_params->decompressed_region.size[1]); break;
        case 3: field = zfp_field_3d(buf, z_type, in_params->decompressed_region.size[0], in_params->decompressed_region.size[1], in_params->decompressed_region.size[2]); break;
        case 4: field = zfp_field_4d(buf, z_type, in_params->decompressed_region.size[0], in_params->decompressed_region.size[1], in_params->decompressed_region.size[2], in_params->decompressed_region.size[3]); break;
        default: LOG_ERROR("Unsupported ndim: %d\n", in_params->decompressed_region.ndim); return false;
    }
    ...
    *region_data = buf;
    ...
    switch (zfp_field_type(field)) {
        case zfp_type_int32:  elem_size = 4; break;
        case zfp_type_int64:  elem_size = 8; break;
        case zfp_type_float:  elem_size = 4; break;
        case zfp_type_double: elem_size = 8; break;
...
pdc_tf_builtin_zfp_compress(pdc_tf_internal_param internal_param, char *params_str, void **region_data,
                            pdc_tf_region_t input_region, pdc_tf_region_t *output_region)
{
    return pdc_tf_builtin_zfp_compress_helper(internal_param, params_str, region_data, input_region, output_region);
}
...
pdc_tf_builtin_zfp_decompress(pdc_tf_internal_param internal_param, char *params_str, void **region_data,
                              pdc_tf_region_t input_region, pdc_tf_region_t *output_region)
{
    return pdc_tf_builtin_zfp_decompress_helper(internal_param, params_str, region_data, input_region, output_region);
}
