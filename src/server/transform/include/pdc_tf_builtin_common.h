...
bool pdc_tf_builtin_double_to_float(pdc_tf_params_t *tf_params, void **region_data, pdc_tf_region_t input_reg,
                                    pdc_tf_region_t *output_reg);
bool pdc_tf_builtin_float_to_double(pdc_tf_params_t *tf_params, void **region_data, pdc_tf_region_t input_reg,
                                    pdc_tf_region_t *output_reg);

#ifdef ENABLE_TF_ZFP_COMPRESSION
bool pdc_tf_builtin_zfp_compress(pdc_tf_params_t *tf_params, void **region_data, pdc_tf_region_t input_reg,
                                 pdc_tf_region_t *output_reg);
