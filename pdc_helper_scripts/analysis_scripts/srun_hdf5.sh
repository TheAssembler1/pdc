...
#   CLIENT_TOTAL_TASKS, N_ELEM, LOG_TAG, RESULTS, OUT_DIR (scratch dir for
#   the HDF5 file this benchmark writes)
...
srun \
  ...
  ./hdf5_bench_magnitude "$N_ELEM" "${OUT_DIR}/hdf5_bench_magnitude_${NUM_NODES}.h5"
popd
